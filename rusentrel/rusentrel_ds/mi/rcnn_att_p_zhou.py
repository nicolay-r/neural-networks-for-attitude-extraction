...
def run_testing_ds_mi_rcnn_pzhou(experiment,
                                 load_model,
    ...
    ExperimentEngine.run_testing(experiment=experiment,
                                 ...
                                 create_network=lambda: network_classtype(context_network=AttentionSelfPZhouRCNN()),
                                 create_config=lambda: config_classtype(context_config=AttentionSelfPZhouRCNNConfig()),
