...
from rusentrel.rusentrel_ds.common import ds_common_callback_modification_func, ds_ctx_common_config_settings
...
def run_testing_ds_rcnn_p_zhou(experiment, common_callback_func=ds_common_callback_modification_func):
